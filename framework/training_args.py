...
def parse_args():
    ...
    # Model
    parser.add_argument('--unlearning_model', type=str, default='retrain',  # retrain
    ...
    parser.add_argument("--mode", type=str, default="disabled", 
                        help="wandb mode")
    parser.add_argument('--lr', type=float, default=1e-3,     # DBLP:1e-3, PubMed:6e-4
                        help='initial learning rate')
    parser.add_argument('--weight_decay', type=float, default=5e-7,     # 5e-7，1e-5
                        help='weight decay')
    ...
    elif args.unlearning_model == 'gradient_ascent' or 'PO' in args.unlearning_model:
        # args.epochs = 201
        # args.valid_freq = 1
        # ogbl-collab NPO
        args.epochs = 301
